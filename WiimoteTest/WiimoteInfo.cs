		...
		private void UpdateWiimoteChanged(WiimoteChangedEventArgs args)
		{
            ...
            switch (ws.ExtensionType)
            {
                ...
                case ExtensionType.WiiUPro:
                    WiiUProBtns.SetItemChecked(0, ws.WiiUPro.A);
                    WiiUProBtns.SetItemChecked(1, ws.WiiUPro.B);
                    WiiUProBtns.SetItemChecked(2, ws.WiiUPro.X);
                    WiiUProBtns.SetItemChecked(3, ws.WiiUPro.Y);
                    WiiUProBtns.SetItemChecked(4, ws.WiiUPro.Minus);
                    WiiUProBtns.SetItemChecked(5, ws.WiiUPro.Home);
                    WiiUProBtns.SetItemChecked(6, ws.WiiUPro.Plus);
                    WiiUProBtns.SetItemChecked(7, ws.WiiUPro.Up);
                    WiiUProBtns.SetItemChecked(8, ws.WiiUPro.Down);
                    WiiUProBtns.SetItemChecked(9, ws.WiiUPro.Left);
                    WiiUProBtns.SetItemChecked(10, ws.WiiUPro.Right);
                    WiiUProBtns.SetItemChecked(11, ws.WiiUPro.L);
                    WiiUProBtns.SetItemChecked(12, ws.WiiUPro.R);
                    WiiUProBtns.SetItemChecked(13, ws.WiiUPro.LZ);
                    WiiUProBtns.SetItemChecked(14, ws.WiiUPro.RZ);
                    WiiUProBtns.SetItemChecked(15, ws.WiiUPro.LS);
                    WiiUProBtns.SetItemChecked(16, ws.WiiUPro.RS);
                    lblCCJoy1.Text = ws.WiiUPro.JoystickLeft.ToString();
                    lblCCJoy2.Text = ws.WiiUPro.JoystickRight.ToString();
                    break;
            }
