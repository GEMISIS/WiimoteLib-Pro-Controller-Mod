...
namespace WiimoteLib
{
	...
	public class WiimoteState
	{
        ...
        /// <summary>
        /// Current state of Wii U Pro Controller
        /// </summary>
        [DataMember]
        public WUPButtonState WiiUPro;
        /// <summary>
    ...
    /// <summary>
    /// Current Wii U Pro Controller button state
    /// </summary>
    [Serializable]
    [DataContract]
    public struct WUPButtonState
    {
        /// <summary>
        /// Normalized left joystick position.  Values range between -0.5 and 0.5
        /// </summary>
        [DataMember]
        public PointF JoystickLeft;
        /// <summary>
        /// Normalized right joystick position.  Values range between -0.5 and 0.5
        /// </summary>
        [DataMember]
        public PointF JoystickRight;
        /// <summary>
        /// Raw left joystick position before normalization.  Values range between 0 and 255.
        /// </summary>
        [DataMember]
        public Point RawJoystickLeft;
        /// <summary>
        /// Raw right joystick position before normalization.  Values range between 0 and 255.
        /// </summary>
        [DataMember]
        public Point RawJoystickRight;
        /// <summary>
        /// Digital button on the Wiimote
        /// </summary>
        [DataMember]
        public bool A, B, X, Y, Plus, Home, Minus, Up, Down, Left, Right, L, R, LZ, RZ, LS, RS;
    }
